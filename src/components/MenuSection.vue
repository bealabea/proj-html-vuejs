    ...
    <div class="big-container menu-container">
      ...
      <div class="menu-box">
        <div class="text-center">
          <h2>DESSERTS</h2>
            <div class="menu-item">
            <h3>CHOCOLATE BALL CAKE</h3>
            <span>$13</span>
            </div>
            <p>Mollis ornare sit sapien, sodales. Cursus duis proin semper quisque.</p>

            <div class="menu-item">
            <h3>LIME PIE WITH CRUST</h3>
            <span>$14</span>
            </div>
            <p>Mollis ornare sit sapien, sodales. Cursus duis proin semper quisque.</p>

            <div class="menu-item">
            <h3>RASPBERRY PEAR CAKE</h3>
            <span>$18</span>
            </div>
            <p>Mollis ornare sit sapien, sodales. Cursus duis proin semper quisque.</p>
...
@import '@/style/menu-section.scss'
</style>
